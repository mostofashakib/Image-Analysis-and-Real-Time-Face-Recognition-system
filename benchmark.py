...
"""
This is a simple program that shows how long does it take to carry out each step of the face recognition step.

Observations:

As the size of the image increases it takes longer time to carry out each step.

Conclusion: For face detection it's better to use a scaled down version of your image and then run face encodings
